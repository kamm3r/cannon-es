...
import { Sphere } from '../geometry/SphereGeometry';
import { Box } from '../geometry/BoxGeometry';
...
export class RigidVehicle {
  ...
  constructor(coordinateSystem?: Vec3, chassisBody?: Rigidbody) {
    this.wheelBodies = [];
    this.coordinateSystem =
      typeof coordinateSystem !== 'undefined'
    ...
    if (chassisBody) {
      ...
      this.chassisBody = new Rigidbody(1);
    }
